...
import me.ihaq.iClient.modules.Render.ChestESP;
...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer<TileEntityChest> {
	...
	public void renderTileEntityAt(TileEntityChest te, double x, double y, double z, float partialTicks,
		...
		if (iClient.getModules().get(7).isToggled() && ChestESP.getESPMode().equals("outline")) {
			GL11.glPushMatrix();
			{
				GL11.glPushAttrib(GL11.GL_ALL_ATTRIB_BITS);
				{
					...
					renderTileEntityAt((TileEntityChest) te, x, y, z, partialTicks, destroyStage);
				}
				GL11.glPopAttrib();
			}
			GL11.glPopMatrix();
