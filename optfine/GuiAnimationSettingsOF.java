...
public class GuiAnimationSettingsOF extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GUIIButton(210, this.width / 2 - 155, this.height / 6 + 168 + 11, 70, 20, "All ON"));
        this.buttonList.add(new GUIIButton(211, this.width / 2 - 155 + 80, this.height / 6 + 168 + 11, 70, 20, "All OFF"));
