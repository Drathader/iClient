...
public class AutoArmor extends Module {
	...
	public void onUpdate() {
        ...
        while (i < 4) {
			...
			if (!(bestArmor == null || currentArmor != null && bestArmor.damageReduceAmount <= currentArmor.damageReduceAmount || mc.thePlayer.inventory.getFirstEmptyStack() == -1 && currentArmor != null || this.delay < 4)) {
                mc.playerController.windowClick(0, 8 - i, 0, 1, mc.thePlayer);
                mc.playerController.windowClick(0, this.bestArmor[i] < 9 ? 36 + this.bestArmor[i] : this.bestArmor[i], 0, 1, Minecraft.getMinecraft().thePlayer);
                this.delay = 0;
